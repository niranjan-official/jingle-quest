...
const Header = ({ UserName }) => {
    ...
    return (
        <div className='w-full p-2 flex justify-between items-center pt-3 pb-3 shadow-2xl fixed z-50'>
            <h1 className='text-2xl text-orange-950 font-semibold font-serif '>Jingle Quest</h1>
            <div className='flex'>
