...
export default function Home() {
  ...
  return (
    <div className="h-screen primary-bg bg-color items-center">
      ...
      <div className="p-2">
        <div className="p-8 flex flex-col border-2 rounded-lg border-white items-center text-white">
          ...
          <div className="flex w-full justify-between text-xs mt-4">
            ...
            <Link href="/signup" className="cursor-pointer ml-8">
              Create new Account?
            </Link>
          </div>
          <button
            onClick={handleSubmit}
            className="l-button rounded-3xl w-1/2 mt-4"
          >
            LOGIN
          </button>
        </div>
